...
void KinematicReconstruction::loadData()
{
  ...
  TString data_path1 = "";
  data_path1.Append("/afs/cern.ch/user/b/bribeiro/CMSSW_9_4_11/src/TopLJets2015/TopAnalysis/KinReco_input_2016_Run2BtoH_25ns_80X_v037_dilep_sel_25Sep2017_NLODY_FineEleID.root");
