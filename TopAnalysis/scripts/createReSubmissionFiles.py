...
def createFiles() :
    ...
    for files in os.listdir("/eos/user/b/bribeiro/f439f08_ul/Chunks/failedjobs/") :
...
#        f.write('python /afs/cern.ch/user/b/bribeiro/CMSSW_9_4_11/src/TopLJets2015/TopAnalysis/scripts/KinAlg4tree.py ${WORKDIR}/${FILENAME} \n')
        f.write("root -l -q -b /afs/cern.ch/user/b/bribeiro/CMSSW_9_4_11/src/TopLJets2015/TopAnalysis/macros/ApplyRegression_systs.C'("'${WORKDIR}/${FILENAME}'")' \n")
        f.write("root -l -q -b /afs/cern.ch/user/b/bribeiro/CMSSW_9_4_11/src/TopLJets2015/TopAnalysis/macros/ApplyMVA_allsysts.C'("'${WORKDIR}/${FILENAME}'")' \n")
